---
description: Advanced mode analysis for comprehensive enterprise-grade specifications for a specific feature.
...
Enhance existing specification with advanced analysis for the feature: **$ARGUMENTS**
...
> Conduct deep threat, risk, and scalability analysis for critical features. For smaller additions, start with standard analysis and increase depth as needed.

## Process

<analysis>
1. **Read existing specifications**: Analyze requirements.md, design.md, and/or tasks.md in the selected feature directory
...
<output>
Present the analysis in a structured format with clear recommendations and actionable items.
</output>

## Context Management

💡 **Tip**: After applying advanced recommendations, use `/spec:validate` to ensure all changes are properly integrated.
